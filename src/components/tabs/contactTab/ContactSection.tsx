                ...
                <div className="px-4 sm:px-1">
                    <div className="pb-4">
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-100">
                            {languageData.contactsSection?.title}
                        </h1>
                    </div>
                    <div>
                        <div className="relative">
                            <input
                                ...
                                placeholder={languageData.contactsSection?.inputPlaceholder}
                            />
                        ...
                        <div className="py-8 border-b border-gray-300 dark:border-gray-800">
                            <button
                                ...
                                {languageData.contactsSection?.newContactButton}
                            </button>
                        </div>
                    </div>
                    <div className="py-4">
                        <div className="pb-4 text-lg font-semibold text-gray-900 dark:text-gray-200">
                            <h1> {languageData.contactsSection?.myContactsTitle}</h1>
                        </div>
